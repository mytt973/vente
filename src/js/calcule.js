...
function log(nool) {
 ...
 let truc=`        
            ...
            <div>
              ...
              <input id="inconu2" class="autre" placeholder="type d'hélicopetaire de combat"></input>
            </div>`;
...
let Data ={
  ...
  id:0,
   ...
   setclass(str){ this.classe=str},
   setEle(str){ this.element=str},
   setId(id){ this.id=id}, //le mascage est du a la priorité de porté,
   changeType(){return this.text=="password"?"password":"text"}
}

const tabOfText= ["name","super","password"]
